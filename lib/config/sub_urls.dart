...
const String updateProfileUrl = "/admin/auth/update-profile";
...
const String appointmentUpdateStatusUrl = "/admin/appointments/update-status";
// ///
const String fetchConstantsUrl = "/admin/constants";
